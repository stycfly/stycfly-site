...
const ARTICLES: [string, string][] = [
  ...
  [
    ...
    "StycFly propose des prestations de photographie et vidéo aérienne par drone pour l'immobilier et tous types d'événements (sportifs, professionnels, culturels ou festifs). Le détail de chaque prestation est précisé dans le devis accepté par le client.",
  ],
  [
