...
export const metadata: Metadata = {
  ...
  description:
    "Prises de vues aériennes professionnelles par drone pour l'immobilier, les événements et les mariages. Télépilote certifié DGAC, basé en Bretagne, devis gratuit sous 24h.",
};
