    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-line">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 900px 500px at 85% -10%, rgba(255,107,74,0.16), transparent 60%), linear-gradient(180deg, #EAF4FC 0%, #FFFFFF 60%)",
          }}
        />
        <div className="mx-auto grid max-w-6xl gap-14 px-6 py-20 md:grid-cols-[1.15fr_0.85fr] md:items-center md:py-28">
          <div>
            <span className="mono-label inline-flex rounded-full border border-sky/30 px-4 py-1.5 text-sky">
              Télépilote DGAC certifié — Bretagne
            </span>
            <h1 className="mt-6 text-[2.6rem] leading-[1.03] text-ink md:text-[4rem]">
              Vidéaste &amp; photographe <em className="text-coral not-italic">drone</em>.
            </h1>
            <p className="mt-6 max-w-[42ch] text-lg text-ink-soft md:text-xl">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              ...
              <Button href="/tarifs" variant="ghost">Voir mes prestations</Button>
            </div>
            ...
            <div className="mt-14 grid gap-px overflow-hidden rounded-xl border border-line bg-line md:grid-cols-3">
              {[
                ...
                <div key={r} className="bg-white p-5">
                  <span className="mono-label text-coral">Résultat</span>
                  <p className="mt-2.5 text-[0.98rem] font-semibold text-ink">{r}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl border border-line">
            <svg viewBox="0 0 400 500" className="h-full w-full" preserveAspectRatio="xMidYMid slice">
              ...
              <g transform="translate(150,215)">
                ...
                <circle cx="0" cy="15" r="9" fill="none" stroke="#0F2436" strokeWidth="1.4" />
                <circle cx="100" cy="15" r="9" fill="none" stroke="#0F2436" strokeWidth="1.4" />
                <line x1="9" y1="15" x2="91" y2="15" stroke="#0F2436" strokeWidth="1.4" />
                <line x1="50" y1="15" x2="50" y2="0" stroke="#0F2436" strokeWidth="1.4" />
                <rect x="40" y="-3" width="20" height="10" rx="2" fill="#0F2436" />
              </g>
            </svg>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="mt-12 flex flex-col divide-y divide-line overflow-hidden rounded-xl border border-line">
          <div className="grid gap-6 bg-white p-8 md:grid-cols-[64px_1.3fr_1fr_auto] md:items-center md:gap-8">
            ...
            <Button href="/immobilier" variant="ghost" className="justify-self-start md:justify-self-end">
              Devis immobilier →
            </Button>
          </div>
          ...
          <div className="grid gap-6 bg-white p-8 md:grid-cols-[64px_1.3fr_1fr_auto] md:items-center md:gap-8">
            ...
            <Button href="/evenements-mariages" variant="ghost" className="justify-self-start md:justify-self-end">
              Devis événement →
            </Button>
          </div>
        </div>
      ...
      <section className="border-y border-line bg-mist">
        <div className="mx-auto max-w-6xl px-6 py-24">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
            <figure className="rounded-xl border border-dashed border-line bg-white p-9">
            ...
            <div className="flex flex-col divide-y divide-line overflow-hidden rounded-xl border border-line">
              {[
                ...
                <div key={label} className="flex items-baseline justify-between gap-4 bg-white px-7 py-6">
